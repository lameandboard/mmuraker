...
class ConsolePage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(title: const Text('G-code Console')),
      body: SafeArea(
        child: ConsolePane(machineId: machineId),
      ),
    );
  }
}

class ConsolePane extends HookConsumerWidget {
  const ConsolePane({super.key, required this.machineId});
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        const Expanded(child: SectionHeader('Console')),
                        IconButton(
